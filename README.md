...
> BeerListViewController.swift
   * 앱을 실행했을 때 보여지는 화면 
      ...
      * PunkAPI에 접속해서 페이지 기반의 데이터를 가져옴 
         ```swift
...
> BeerListCell.swift
   * BeerListViewController에 표현될 셀을 설정
      * beerImageView, nameLabel, tagelineLabel의 전체적인 속성과 autolayout을 설정
        ```swift
         // autolayout
...
> Beer.swift
   * beer에 대한 entity 설정
      * 서버에서 보내주는 값을 제대로 받아올 수 있도록 임의로 선언한 변수에 서버의 키 값을 설정해줌
      ```swift
